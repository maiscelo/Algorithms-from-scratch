...
X_train, X_test, y_train, y_test = train_test_split(im_total, labels_total, test_size=0.33, random_state=42)
...
y_train = y_train -1
y_valid = y_valid -1
x_train, y_train, x_valid, y_valid = map(torch.tensor, (dataIn2D, y_train, testeIn2D, y_test))
